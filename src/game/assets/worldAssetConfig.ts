...
export const WORLD_ASSET_SLOT_DEFINITIONS: readonly WorldAssetSlotDefinition[] = [
  ...
  { id: 'seeded.decoration.grass', group: 'seeded', label: '草叶', category: 'vegetation', tree: false, collidable: false, generated: true, defaultBinding: binding('builtin:vegetation/草叶-001', 'height', 18, 0.85, undefined, undefined, 1) },
